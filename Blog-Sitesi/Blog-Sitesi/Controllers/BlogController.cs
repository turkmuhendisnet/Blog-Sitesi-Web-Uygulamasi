...
namespace Blog_Sitesi.Controllers
{
    public class BlogController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Baslik,Aciklama,Resim,Icerik,EklemeTarihi,Onay,Anasayfa,KategoriId")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Baslik,Aciklama,Resim,Icerik,EklemeTarihi,Onay,Anasayfa,KategoriId")] Blog blog)
        {
            if (ModelState.IsValid)
            {
